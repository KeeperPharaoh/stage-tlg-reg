    ...
    const checkRegistration = async () => {
      try {
        const resp = await axios.post(
          'https://stage-platform.kazllm.site/telegram/auth/check',
          { chat_id: chatId }
        );
  ...
  const onSubmit = async data => {
    ...
    try {
      if (step === 'email_input') {
        setEmail(data.email);
        const resp = await axios.post(
          'https://stage-platform.kazllm.site/telegram/auth/code/send',
          { email: data.email }
        );
        if (resp.data.status) {
        ...
        const resp = await axios.post(
          'https://stage-platform.kazllm.site/telegram/auth/code/check',
        ...
        const resp = await axios.post(
          'https://stage-platform.kazllm.site/telegram/auth/registration',
          registrationPayload
        );
        if (resp.data.status) {
